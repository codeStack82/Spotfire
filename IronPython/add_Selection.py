...
# 3.0 - Get a list of Selected Bha wells
bha_SelectedWells = get_BhaSelectedwells(bhaTable)

# 4.0 - Tags bha(s) selected wells as bhaSelected in the wellsTable
tag_bhaSelectedItems('bhaSelected', wellsTable, bha_SelectedWells)
